...
* **PostgreSQL:** Zaman serisi verilerini güvenli ve ilişkisel olarak saklayan veritabanı.
...
Sistem aktif olarak sunucunun RAM kullanımını saniyede bir ölçer ve Grafana arayüzüne tıkır tıkır aktarır. İşte projeden farklı görselleştirme kesitleri:
...
### 4. Genel Dashboard ve Geçmiş Zaman Analizi
Sistemin geniş zaman aralıklarındaki kaynak tüketim davranışını gösteren çizgi grafik.
![Genel Dashboard](grafana-dashboard-overview.png)
